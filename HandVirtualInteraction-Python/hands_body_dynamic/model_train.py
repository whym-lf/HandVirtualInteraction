...
# static action
# actions = np.array(['index_finger_right', 'index_finger_forward', 'open_hand_right', 'open_hand_forward'])
...
model.summary()
model.save('action' + str(epoch) + "_" + str(sequence_length) + "_" + str(len(actions)) + '.h5')
